...
public class FullscreenReading extends AppCompatActivity
{
    ...
    private static boolean isGettedPrmission = false;

    public synchronized static boolean isIsGettedPrmission()
    {
        return isGettedPrmission;
    }
        ...
        lvMain.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                if(file.isDirectory())
                {
                    ...
                    editor.putString("folderPath", file.getAbsolutePath());
                    editor.commit();
                    String savedPath = sp.getString("folderPath", "");*/
                    BufferedWriter bw = null;
                    try
                    {
                        bw = new BufferedWriter(new OutputStreamWriter(
                                openFileOutput("folderPath.txt", MODE_PRIVATE)));
